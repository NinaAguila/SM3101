...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $query = mysqli_query($bd, "SELECT * FROM tbempcontact WHERE email='$email'");
...
?>
    ...
    <body>
        ...
        <section id="container">
            <?php include("includes/header.php"); ?> <!--/*papaltan pa to sa student to galing */-->
            <?php include("includes/sidebar.php"); ?><!--/*eto din */-->
