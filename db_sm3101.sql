...
CREATE TABLE IF NOT EXISTS `item` (
  ...
  `size` varchar(255) CHARACTER SET utf8mb4 DEFAULT 'NONE',
  `img` longblob NOT NULL,
  PRIMARY KEY (`Item_ID`)
...
CREATE TABLE IF NOT EXISTS `orders` (
  ...
  `statuss` enum('Ready for Pickup','Pending','Recieved') CHARACTER SET utf8mb4 NOT NULL DEFAULT 'Pending',
...
CREATE TABLE IF NOT EXISTS `tbeventdetail` (
  ...
  `eventWho` varchar(30) CHARACTER SET utf8mb4 NOT NULL,
  PRIMARY KEY (`eventId`),
...
CREATE TABLE IF NOT EXISTS `tbeventview` (
  `srCode` varchar(50) CHARACTER SET utf8mb4 DEFAULT NULL,
